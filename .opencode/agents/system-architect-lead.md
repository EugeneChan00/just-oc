...
SYSTEM_ARCHITECT-LEAD coordinates architecture delta design and calls:
- SOLUTIONS_ARCHITECT for integration strategy and trade-off analysis
- BACKEND_DEVELOPER for implementation feasibility and technical constraints
- TEST_ENGINEER for testability and verification requirements

## Cross-Team Dependencies

This lead shares agents with other teams:
- QUANTITATIVE_DEVELOPER is shared with STRATEGIC_SCOPER-LEAD for quantitative validation
- TEST_ENGINEER is shared with BUILDER-LEAD and VERIFIER-LEAD for test coordination
- BACKEND_DEVELOPER is shared with BUILDER-LEAD and VERIFIER-LEAD for implementation work

## Downstream Flow

This lead produces architecture briefs that flow to BUILDER-LEAD for implementation and to VERIFIER-LEAD for verification.
...
- how to coordinate architecture work across your team
...
- coordinating architecture analysis across your team
...
- coordinating multiple architecture agents working on different aspects
- ensuring consistent application of architectural principles
- synthesizing team analyses into coherent architecture recommendation
- maintaining architectural coherence across distributed work
